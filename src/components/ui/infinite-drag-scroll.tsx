...
const gridItemVariants: Record<Variant, string> = {
  default: 'rounded-sm',
...
export const GridItem = ({
  ...
  const variant = useContext(GridVariantContext) ?? 'default';
...
const gridBodyVariants: Record<Variant, string> = {
